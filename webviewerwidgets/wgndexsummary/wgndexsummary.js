$.getScript('/result/widgetfile/wgndexsummary/cytoscape.js', function () {});

widgetGenerators['ndexsummary'] = {
    'info': {
        'name': 'NDEx NCI Cancer Pathways Enrichment Summary',
        'width': 580, 
        'height': 380, 
        'callserver': true,
        ...
        'function': function (parentDiv, data) {
            ...
            func.networkDiv.addEventListener('click', function (evt) {
                var options = document.getElementById('ndexsummary_options_summary');
            ...
            // Network name area
            var div = getEl('div');
            div.id = 'ndexsummary_select_summary';
            div.className = 'ndexsummary_select_summary';
            ...
            optionsDiv.id = 'ndexsummary_options_summary';
            ...
            for (var i = 0; i < enrichmentScoresFormatedForTable['body'].length; i++) {
                ...
                optionDiv.className = 'ndexsummary_option_summary';
                ...
                optionDiv.onmouseenter = function (evt) {
                    document.getElementById('ndexsummary_select_summary').textContent = 
                        'v ' + evt.target.getAttribute('networkname');
                    var options = document.getElementsByClassName('ndexsummary_option_summary');
                    ...
                    document.getElementById('ndexsummary_options_summary').focus();
                }
                optionDiv.onclick = function (evt) {
                    document.getElementById('ndexsummary_options_summary').style.display 
                        = 'none';
                    var networkUUID = evt.target.getAttribute('networkid');
                    self.selectedNetworkName = evt.target.getAttribute('networkname');
                    var selectDiv = document.getElementById('ndexsummary_select_summary');
            ...
            optionsDiv.style.display = 'none';
            var select = func.enrichmentDiv.getElementsByClassName('ndexsummary_select_summary')[0];
