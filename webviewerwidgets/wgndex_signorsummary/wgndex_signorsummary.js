$.getScript('/result/widgetfile/wgndex_signorsummary/cytoscape.js', function () {});

widgetGenerators['ndex_signorsummary'] = {
    'info': {
        'name': 'NDEx Signor Pathways Enrichment Summary',
        'width': 580, 
        'height': 380, 
        'callserver': true,
        ...
        'function': function (parentDiv, data) {
            ...
            func.enrichmentDiv.id = "ndex_signorsummary_list_summary";
            ...
            func.networkDiv.id = "ndex_signorsummary_canvas_summary";
            ...
            func.networkDiv.addEventListener('click', function (evt) {
                var options = document.getElementById('ndex_signorsummary_options_summary');
            ...
            func.legendDiv.id = 'ndex_signorsummary_legend_summary';
            ...
            // Network name area
            var div = getEl('div');
            div.id = 'ndex_signorsummary_select_summary';
            div.className = 'ndex_signorsummary_select_summary';
            ...
            div.onclick = function (evt) {
                ...
                var optionsDiv = document.getElementById(
                        'ndex_signorsummary_options_summary');
            ...
            optionsDiv.id = 'ndex_signorsummary_options_summary';
            ...
            for (var i = 0; i < enrichmentScoresFormatedForTable['body'].length; i++) {
                ...
                optionDiv.className = 'ndex_signorsummary_option_summary';
                ...
                optionDiv.onmouseenter = function (evt) {
                    document.getElementById('ndex_signorsummary_select_summary').textContent = 
                        'v ' + evt.target.getAttribute('networkname');
                    var options = document.getElementsByClassName(
                            'ndex_signorsummary_option_summary');
                    ...
                    document.getElementById('ndex_signorsummary_options_summary').focus();
                }
                optionDiv.onclick = function (evt) {
                    document.getElementById(
                            'ndex_signorsummary_options_summary').style.display 
                            = 'none';
                    ...
                    var selectDiv = document.getElementById(
                            'ndex_signorsummary_select_summary');
                ...
                for (var j = 0; j < geneNames.length; j = j + noGenesPerOption) {
                    ...
                    optionDiv.onmouseenter = function (evt) {
                        document.getElementById('ndex_signorsummary_select_summary').textContent = 
                            'v ' + evt.target.getAttribute('networkname');
                        var options = document.getElementsByClassName('ndex_signorsummary_option_summary');
                        for (var j = 0; j < options.length; j++) {
                            var option = options[j];
                            if (option.getAttribute('networkid') == 
                                evt.target.getAttribute('networkid')) {
                    ...
                    optionDiv.onclick = function (evt) {
                        document.getElementById('ndex_signorsummary_options_summary').style.display 
                            = 'none';
                        var networkUUID = evt.target.getAttribute('networkid');
                        self.selectedNetworkName = evt.target.getAttribute('networkname');
                        var selectDiv = document.getElementById('ndex_signorsummary_select_summary');
                        selectDiv.textContent
            ...
            var option = optionsDiv.getElementsByClassName(
                    'ndex_signorsummary_option_summary')[0];
            if (option == undefined) {
                return;
            }
            ...
            optionsDiv.style.display = 'none';
            var select = func.enrichmentDiv.getElementsByClassName('ndex_signorsummary_select_summary')[0];
