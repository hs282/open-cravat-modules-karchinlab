$.getScript('/result/widgetfile/wgndex_chdsummary/cytoscape.js', function () {});

widgetGenerators['ndex_chdsummary'] = {
    'info': {
        'name': 'NDEx Congenital Heart Disease Pathways Enrichment Summary',
        'width': 580, 
        'height': 380, 
        'callserver': true,
        'beforecallserver': function () {
            ...
            for (var i = 0; i < geneRows.length; i++) {
                ...
                var pval = getWidgetData('gene', 'ndex', row, 'gene_pval');
                hugos.push(hugo)
            }
            hugos.sort();
            this['variables']['hugos'] = hugos;
            this['variables']['callserverparams'] = {'hugos': hugos};
        },
        'variables': {zoom: 1.0},
        'beforeresize': function () {
            var div = this['variables']['div'];
            $(div).empty();
            div.style.width = '0';
            div.style.height = '0';
        },
        ...
        'function': function (parentDiv, data) {
            ...
            addEl(parentDiv, btn);
            // Below is from ajax call.
            var data = this['variables']['data'];
            var enrichmentResponseScores = data['scores'];
            ...
            func.enrichmentDiv.id = "ndex_chdsummary_list_summary";
            ...
            func.enrichmentDiv.style.width = 'calc(100% - 53px)';
            func.enrichmentDiv.style.height = '';
            addEl(parentDiv, func.enrichmentDiv);
            //Network Div
            func.networkDiv = getEl('div');
            func.networkDiv.id = "ndex_chdsummary_canvas_summary";
            ...
            func.networkDiv.addEventListener('click', function (evt) {
                var options = document.getElementById('ndex_chdsummary_options_summary');
            ...
            func.legendDiv.id = 'ndex_chdsummary_legend_summary';
            ...
            // Network name area
            var div = getEl('div');
            div.id = 'ndex_chdsummary_select_summary';
            div.className = 'ndex_chdsummary_select_summary';
            ...
            div.onclick = function (evt) {
                ...
                var optionsDiv = document.getElementById(
                        'ndex_chdsummary_options_summary');
            ...
            optionsDiv.id = 'ndex_chdsummary_options_summary';
            ...
            for (var i = 0; i < enrichmentScoresFormatedForTable['body'].length; i++) {
                ...
                optionDiv.className = 'ndex_chdsummary_option_summary';
                ...
                optionDiv.onmouseenter = function (evt) {
                    document.getElementById('ndex_chdsummary_select_summary').textContent = 
                        'v ' + evt.target.getAttribute('networkname');
                    var options = document.getElementsByClassName(
                            'ndex_chdsummary_option_summary');
                    ...
                    document.getElementById('ndex_chdsummary_options_summary').focus();
                }
                optionDiv.onclick = function (evt) {
                    document.getElementById(
                            'ndex_chdsummary_options_summary').style.display 
                            = 'none';
                    ...
                    var selectDiv = document.getElementById(
                            'ndex_chdsummary_select_summary');
                ...
                for (var j = 0; j < geneNames.length; j = j + noGenesPerOption) {
                    ...
                    optionDiv.onmouseenter = function (evt) {
                        document.getElementById('ndex_chdsummary_select_summary').textContent = 
                            'v ' + evt.target.getAttribute('networkname');
                        var options = document.getElementsByClassName('ndex_chdsummary_option_summary');
                        for (var j = 0; j < options.length; j++) {
                            var option = options[j];
                            if (option.getAttribute('networkid') == 
                                evt.target.getAttribute('networkid')) {
                    ...
                    optionDiv.onclick = function (evt) {
                        document.getElementById('ndex_chdsummary_options_summary').style.display 
                            = 'none';
                        var networkUUID = evt.target.getAttribute('networkid');
                        self.selectedNetworkName = evt.target.getAttribute('networkname');
                        var selectDiv = document.getElementById('ndex_chdsummary_select_summary');
                        selectDiv.textContent
            ...
            var option = optionsDiv.getElementsByClassName(
                    'ndex_chdsummary_option_summary')[0];
            if (option == undefined) {
                return;
            }
            var networkUUID = option.getAttribute('networkid');
            var networkName = option.getAttribute('networkname');
            self.selectedNetworkName = networkName;
            optionsDiv.style.display = 'none';
            var select = func.enrichmentDiv.getElementsByClassName('ndex_chdsummary_select_summary')[0];
